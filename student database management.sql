create database studentdatabasemanagement;  # creting a database

use studentdatabasemanagement; # providing which database is being used
...
('Electronics Engineering', 'Jack Clark'),
...
VALUES
    ...
    ('Data Structures and Algorithms', 1, 5),
...
VALUES
    ...
    ('Thermodynamics', 4, 5),
    ('Fluid Mechanics', 4, 4),
    ('Manufacturing Processes', 4, 4),
    ('Machine Design', 4, 5);

-- Inserting courses for Civil Engineering (department_id = 5)
INSERT INTO Courses (course_name, department_id, credits)
VALUES
    ('Structural Analysis', 5, 4),
    ('Geotechnical Engineering', 5, 5),
